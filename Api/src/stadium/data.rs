...
pub fn generate_stadium() -> HashMap<String, Zone> {
    ...
    for zone_name in zone_names.iter() {
        ...
        for category_name in categories_names.iter() {
            ...
            let row_1 = Row {
                seats: create_rows(
                    zone_name.parse().unwrap(),
                    *category_name,
                    'w',
                    1.00 * (25.00 - visibility_rate) / 100.00,
                    10,
                ),
            };
            let row_2 = Row {
                seats: create_rows(
                    ...
                    *category_name,
                    'x',
                    2.00 * (25.00 - visibility_rate) / 100.00,
                    10,
                ),
            };
            ...
            let row_3 = Row {
                seats: create_rows(
                    ...
                    *category_name,
                    'y',
                    3.00 * (25.00 - visibility_rate) / 100.00,
                    10,
                ),
            };
            ...
            let row_4 = Row {
                seats: create_rows(
                    ...
                    *category_name,
                    'z',
                    4.00 * (25.00 - visibility_rate) / 100.00,
                    10,
                ),
            };

            category.rows.insert('w', row_1);
            category.rows.insert('x', row_2);
            category.rows.insert('y', row_3);
            category.rows.insert('z', row_4);
